...
| `debug-view.browser.js` | `node tests/debug-view.browser.js` | The Debug screen's payload view: "As sent" is the default and renders the real messages as plain text (no capsule JSON), the switch flips to capsules and back, and the choice is remembered. |
